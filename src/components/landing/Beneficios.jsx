  ...
  return (
    <section className='py-20 px-6 bg-transparent'>
      <div className='max-w-4xl mx-auto'>
        {/* Label superior */}
        <p className='text-center text-[11px] font-bold tracking-[0.2em] uppercase mb-4' style={{ color: brand }}>
          ¿Por qué DATE?
        </p>

        {/* Título con Serif */}
        <h2 className='text-center text-3xl md:text-4xl text-slate-900 mb-16 leading-tight' style={{ fontFamily: serif }}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          {razones.map((item, idx) => (
            ...
            >
              ...
              <h4 className='text-[16px] font-bold text-slate-900 mb-3'>{item.title}</h4>
